        ...
        <div>
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 sticky top-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-gray-500">All prices in GBP (£)</div>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-medium text-blue-900">
                      £{costs.setupCost.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-600">Running Cost</span>
                    <span className="font-medium text-blue-900">
                      £{costs.runningCost.toFixed(2)}
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-medium text-gray-900">
                      £{costs.traditionalCost.toFixed(2)}
                    </span>
                  </div>
                  <div className="pt-3 border-t border-gray-200">
                    <div className="bg-green-50 rounded-lg p-3">
                      ...
                      <div className="text-xs text-green-600">
                        {(
                          ((costs.traditionalCost - costs.totalCost) /
                            costs.traditionalCost) *
                          100
                        ).toFixed(0)}
    ...
    >
      ...
      <div className="text-sm">
        <div className="text-blue-600">
          Setup: £{costs.setupCost.toFixed(2)}
        </div>
        <div className="text-blue-600">
          Per min: £{costs.perMinuteCost.toFixed(2)}
        </div>
      </div>
      {required && (
